...
* For Windows users alternatively a [binary](https://github.com/gcormier/megaconnect/tree/main/binary) is provided which does not require a Python installation
